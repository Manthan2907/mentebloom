import{r as w,j as e}from"./index-DqHEeOPB.js";import{u as Q}from"./store-D42cczNO.js";import{R as U,T as Z,P as ee,M as te}from"./Triangle-2qzboODN.js";import{B as oe}from"./brain-DSwn6B3O.js";import{A as ne}from"./index-DcPPOp89.js";import{m as ie}from"./proxy-DqwYA9zY.js";import{C as se,a as ae}from"./chevron-right-ybSG78_W.js";const z=o=>{const s=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o);return s?[parseInt(s[1],16)/255,parseInt(s[2],16)/255,parseInt(s[3],16)/255]:[1,1,1]},re=o=>o==="ember"?1:o==="frost"?2:0,le=`#version 300 es
in vec2 position;
void main() {
