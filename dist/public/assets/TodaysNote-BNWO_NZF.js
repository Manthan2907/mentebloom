import{r as w,j as e}from"./index-CWQa-JQK.js";import{u as Q}from"./store-DzrNlw1i.js";import{R as U,T as Z,P as ee,M as te}from"./Triangle-2qzboODN.js";import{B as oe}from"./brain-cCBhFjF6.js";import{A as ne}from"./index-Dzczec5l.js";import{m as ie}from"./proxy-D3gJo6JU.js";import{C as se,a as ae}from"./chevron-right-DQO6QqTJ.js";const z=o=>{const s=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o);return s?[parseInt(s[1],16)/255,parseInt(s[2],16)/255,parseInt(s[3],16)/255]:[1,1,1]},re=o=>o==="ember"?1:o==="frost"?2:0,le=`#version 300 es
in vec2 position;
void main() {
