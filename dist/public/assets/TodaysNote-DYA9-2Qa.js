import{r as C,j as e}from"./index-BeWtibCC.js";import{R as Q,T as U,P as Z,M as ee}from"./Triangle-2qzboODN.js";import{A as te}from"./index--4zKOK52.js";import{m as oe}from"./proxy-DXlPNsXn.js";import{C as ne,a as ie}from"./chevron-right-DuB1c3Qs.js";const A=o=>{const s=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o);return s?[parseInt(s[1],16)/255,parseInt(s[2],16)/255,parseInt(s[3],16)/255]:[1,1,1]},se=o=>o==="ember"?1:o==="frost"?2:0,ae=`#version 300 es
in vec2 position;
void main() {
