...
export function Footer() {
  return (
    <div className="relative">
      <div className="absolute -top-[20vw] left-0 right-0 w-full h-[50vw] -z-10 overflow-hidden pointer-events-none">
        <Image src="/images/footer-bg.png" alt="Tuscan landscape" fill className="object-cover" priority />
      </div>



      <footer id="contact" className="relative z-10 border-t border-border py-16 px-6 bg-background">
